...
The RSA keys were generated programattically using Key pair generator, below was the code that was used to generate the RSA private and the public key pairs, it was run twice to generate two sets of keys. One pair to use with the server, the other to use it with the client
